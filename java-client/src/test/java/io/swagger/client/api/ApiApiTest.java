...
public class ApiApiTest {
    ...
    public void pdfWebapiAddnumberPostTest() throws Exception {
        ...
        PageNumberHorizontalAlign hAlignment = PageNumberHorizontalAlign.C;
        PageNumberVerticalAlign vAlignment = PageNumberVerticalAlign.B;
    ...
    public void pdfWebapiChangeFontsPostTest() throws Exception {
        ...
        List<File> files = Arrays.asList(new File("/home/tigra/Service/TestData/test.pdf"));;
        FileResponse response = api.pdfWebapiChangeFontsPost(fontReplacementsJson, files);
        System.out.println(response);
        // TODO: test validations
    }
    /**
    ...
    public void pdfWebapiCompressPostTest() throws Exception {
        List<File> files =  Arrays.asList(new File("/home/tigra/Service/TestData/test.pdf"));
        CompressType compressType = CompressType.HIGH;
    ...
    public void pdfWebapiConvertPostTest() throws Exception {
        ...
        XmlType xmlType = XmlType.MOBIXML;
        String xmlTag = "tag";
        Integer fontSise = 10;
    ...
    public void pdfWebapiMergePostTest() throws Exception {
        ...
        MergeImageType mergeType = MergeImageType.HORIZONTAL;
    ...
    public void pdfWebapiMetadataPostTest() throws Exception {
        ...
        MetadataOperation operation = MetadataOperation.GET;
    ...
    public void pdfWebapiResizePostTest() throws Exception {
        ...
        String inputType = "bmp";
        String outputType = "bmp";
        ResizeType resizeType = ResizeType.PERCENTAGE;
        ResizePresetType presetType = ResizePresetType.FACEBOOK;
        ResizePresetSize presetSize = ResizePresetSize.FACEBOOK_POST;
        Integer width = 1;
        Integer height = 1;
        Integer percentage = 1;
        Boolean useProportions = true;
        ResizePageSize pageSize = ResizePageSize.A4;
    ...
    public void pdfWebapiRotatePostTest() throws Exception {
        List<File> files = Arrays.asList(new File("/home/tigra/Service/TestData/test.pdf"));
        RotateAngle angle = RotateAngle.ON90;
        RotateType rotateType = RotateType.A;
        String pageNum = "1";
    ...
    public void pdfWebapiSignaturePostTest() throws Exception {
        ...
        String inputType = "pdf";
        String outputType = "pdf";
        SignatureType signatureType = SignatureType.TEXT;
    ...
    public void pdfWebapiSplitimagePostTest() throws Exception {
        List<File> files = Arrays.asList(new File("/home/tigra/Service/TestData/test.bmp"));
        SplitImageType splitType = SplitImageType.VERTICAL;
        Integer vertical = 1;

...
public class WebapiFormfillerBody {
  ...
  public WebapiFormfillerBody files(List<File> files) {
    this.files = files;
    return this;
  }

  public WebapiFormfillerBody addFilesItem(File filesItem) {
    if (this.files == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    WebapiFormfillerBody webapiFormfillerBody = (WebapiFormfillerBody) o;
    return Objects.equals(this.files, webapiFormfillerBody.files);
  }

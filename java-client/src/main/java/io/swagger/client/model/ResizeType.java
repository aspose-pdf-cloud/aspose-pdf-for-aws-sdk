...
/**
 * Gets or Sets ResizeType
 */
@JsonAdapter(ResizeType.Adapter.class)
public enum ResizeType {
  ...
  public static ResizeType fromValue(String input) {
  ...
  public static class Adapter extends TypeAdapter<ResizeType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ResizeType enumeration) throws IOException {
      jsonWriter.value(String.valueOf(enumeration.getValue()));
    }

    @Override
    public ResizeType read(final JsonReader jsonReader) throws IOException {
      Object value = jsonReader.nextString();
      return ResizeType.fromValue((String)(value));
    }
  }
}

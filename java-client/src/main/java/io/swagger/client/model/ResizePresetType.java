...
/**
 * Gets or Sets ResizePresetType
 */
@JsonAdapter(ResizePresetType.Adapter.class)
public enum ResizePresetType {
  ...
  public static ResizePresetType fromValue(String input) {
    for (ResizePresetType b : ResizePresetType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ResizePresetType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ResizePresetType enumeration) throws IOException {
      jsonWriter.value(String.valueOf(enumeration.getValue()));
    }

    @Override
    public ResizePresetType read(final JsonReader jsonReader) throws IOException {
      Object value = jsonReader.nextString();
      return ResizePresetType.fromValue((String)(value));
    }
  }
}

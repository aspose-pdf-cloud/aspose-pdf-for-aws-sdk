...
public class WebapiSearchableBody {
  ...
  public WebapiSearchableBody files(List<File> files) {
    this.files = files;
    return this;
  }

  public WebapiSearchableBody addFilesItem(File filesItem) {
    if (this.files == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    WebapiSearchableBody webapiSearchableBody = (WebapiSearchableBody) o;
    return Objects.equals(this.files, webapiSearchableBody.files);
  }

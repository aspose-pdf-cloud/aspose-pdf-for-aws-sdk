...
public class WebapiHashBody {
  ...
  public WebapiHashBody files(List<File> files) {
    this.files = files;
    return this;
  }

  public WebapiHashBody addFilesItem(File filesItem) {
    if (this.files == null) {
  ...
  **/
  ...
  public WebapiHashBody documentPassword(String documentPassword) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    WebapiHashBody webapiHashBody = (WebapiHashBody) o;
    return Objects.equals(this.files, webapiHashBody.files) &&
        Objects.equals(this.documentPassword, webapiHashBody.documentPassword);
  }

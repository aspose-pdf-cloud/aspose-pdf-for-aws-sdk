 ...
 */
export type SplitImageType = 'Vertical' | 'Horizontal' | 'Both';

export const SplitImageType = {
    Vertical: 'Vertical' as SplitImageType,
    Horizontal: 'Horizontal' as SplitImageType,
    Both: 'Both' as SplitImageType
};
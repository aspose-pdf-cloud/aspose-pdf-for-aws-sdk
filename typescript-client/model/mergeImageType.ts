...
export type MergeImageType = 'Vertical' | 'Horizontal' | 'Both';

export const MergeImageType = {
    Vertical: 'Vertical' as MergeImageType,
    Horizontal: 'Horizontal' as MergeImageType,
    Both: 'Both' as MergeImageType
};
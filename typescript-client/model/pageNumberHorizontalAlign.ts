...
export type PageNumberHorizontalAlign = 'C' | 'L' | 'R';

export const PageNumberHorizontalAlign = {
    C: 'C' as PageNumberHorizontalAlign,
    L: 'L' as PageNumberHorizontalAlign,
    R: 'R' as PageNumberHorizontalAlign
};
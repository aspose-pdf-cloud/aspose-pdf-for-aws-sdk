 ...
 */
export type FileProcessingErrorCode = 'OK' | 'NoImagesFound' | 'NoSearchResults' | 'WrongRegExp';

export const FileProcessingErrorCode = {
    OK: 'OK' as FileProcessingErrorCode,
    NoImagesFound: 'NoImagesFound' as FileProcessingErrorCode,
    NoSearchResults: 'NoSearchResults' as FileProcessingErrorCode,
    WrongRegExp: 'WrongRegExp' as FileProcessingErrorCode
};
...
export type ResizePresetType = 'Instagram' | 'Facebook' | 'Twitter' | 'Youtube' | 'Pinterest' | 'LinkedIn' | 'Snapchat' | 'Standard';

export const ResizePresetType = {
    Instagram: 'Instagram' as ResizePresetType,
    Facebook: 'Facebook' as ResizePresetType,
    Twitter: 'Twitter' as ResizePresetType,
    Youtube: 'Youtube' as ResizePresetType,
    Pinterest: 'Pinterest' as ResizePresetType,
    LinkedIn: 'LinkedIn' as ResizePresetType,
    Snapchat: 'Snapchat' as ResizePresetType,
    Standard: 'Standard' as ResizePresetType
};
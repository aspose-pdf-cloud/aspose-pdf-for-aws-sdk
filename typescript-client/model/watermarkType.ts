...
export type WatermarkType = 'None' | 'Artifact' | 'Text' | 'Image';

export const WatermarkType = {
    None: 'None' as WatermarkType,
    Artifact: 'Artifact' as WatermarkType,
    Text: 'Text' as WatermarkType,
    Image: 'Image' as WatermarkType
};
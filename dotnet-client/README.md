...
1. **Clone the Repository**
   ...
   Clone the repository containing the .NET Core project to your local machine.

```bash
git clone https://github.com/aspose-pdf-cloud/aspose-pdf-for-aws-sdk.git
cd dotnet-client
```
2. Restore the Packages

Run the following command to restore the packages specified in the .csproj file.

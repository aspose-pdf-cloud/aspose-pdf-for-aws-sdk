...
/**
 * WebapiEsignBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WebapiEsignBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'webapi_esign_body';
    ...
    {
        $this->container['passw'] = isset($data['passw']) ? $data['passw'] : null;
    ...
    {
        return $this->container['passw'];
    }

    /**
     * Sets passw
     *
     * @param string $passw passw
     *
     * @return $this
     */
    public function setPassw($passw)
    {
        $this->container['passw'] = $passw;

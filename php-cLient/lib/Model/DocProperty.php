 ...
 *
 * @category Class
 * @description Represents a document property.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DocProperty implements ModelInterface, ArrayAccess
{
     ...
     * Sets key
     *
     * @param string $key Gets or sets the key of the property.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Gets or sets the name of the property.
     *
     * @return $this
     */
     ...
     * Sets read_only
     *
     * @param bool $read_only Gets or sets a value indicating whether the property is read-only.
     *
     * @return $this
     */
